...
namespace BAL
{
    public class PDFFooter : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            cell = new PdfPCell(new Phrase(_strName, font10));
            cell.HorizontalAlignment = Rectangle.ALIGN_LEFT;
            cell.Border = Rectangle.NO_BORDER;
            tabFot.AddCell(cell);
            
            cell = new PdfPCell(new Phrase(DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss tt"), font10));
            cell.HorizontalAlignment = Rectangle.ALIGN_CENTER;
            cell.Border = Rectangle.NO_BORDER;
            tabFot.AddCell(cell);
            cell = new PdfPCell(new Phrase(writer.PageNumber.ToString(), font10));
